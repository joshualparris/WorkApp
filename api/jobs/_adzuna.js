export const DEFAULT_REFRESH_QUERIES = [
  ...
  { profileTarget: 'josh', query: 'desktop support' },
  { profileTarget: 'josh', query: 'administration officer' },
  { profileTarget: 'josh', query: 'education administration' },
  { profileTarget: 'josh', query: 'student services' },
  { profileTarget: 'josh', query: 'customer service officer' },
  { profileTarget: 'josh', query: 'client services officer' },
  { profileTarget: 'josh', query: 'records officer' },
  { profileTarget: 'josh', query: 'scheduling officer' },
  ...
  { profileTarget: 'kristy', query: 'paediatric nurse' },
  ...
  { profileTarget: 'kristy', query: 'maternal child health nurse' },
  { profileTarget: 'kristy', query: 'early parenting nurse' },
  { profileTarget: 'kristy', query: 'rehabilitation nurse' },
  { profileTarget: 'kristy', query: 'hospital nurse' },
];
